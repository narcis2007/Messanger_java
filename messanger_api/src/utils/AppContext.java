...
//                    Field field = bean.getClass().getDeclaredField(fieldName);
    ...
    private BeanInfo createBean(String id, String className) {
        try {
            ...
            //merge : bean = Class.forName("ro.ubbcluj.cs.email_client.repository.EmailRepository").getDeclaredConstructor(EmailValidator.class,String.class).newInstance(new EmailValidator(),"emails.xml");
